...
impl AgentBackendDeveloper {
    pub fn new() -> Self {
        let attributes = BasicAgent {
            objective: "Develope backend code for webserver and join database".to_string(),
    ...
    async fn call_extract_rest_api_endpoints(&self) -> String {
        let backend_code: String = read_exec_main_content();
            ...
            match self.attributes.state {
                ...
                AgentState::UnitTesting => {
                    ...
                    let build_backend_server: std::process::Output = Command::new("cargo")
                        ...
                        .stderr(Stdio::piped())
                        .output()
                        .expect("Faild to build backend application");
                    ...
                    */
                    ...
                    let mut run_backend_server: std::process::Child = Command::new("cargo")
                        ...
                        .stderr(Stdio::piped())
                        .spawn()
                        .expect("Faild to run backend application");
...
mod tests {
    ...
    async fn tests_writeing_backend_code() {
        ...
        let factsheet_str: &str = r#"
            {
                "project_description": "build a website that fetches and tracks fitness progress with timezone information from the web.",
                "project_scope": {
